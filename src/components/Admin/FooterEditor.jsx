...
const FooterEditor = () => {
  ...
  const sections = [
    ...
    { id: 'navigation', name: 'Navigation Section' }
  ];

  return (
    <div className="max-w-6xl mx-auto">
      <h2 className="text-2xl font-bold font-['Raleway'] mb-6">Edit Footer Content</h2>
      ...
      <div className="mb-8 p-4 bg-gray-50 rounded-lg">
        ...
        <ul className="list-disc list-inside text-gray-700 text-sm space-y-1">
          ...
          <li>Use &lt;br/&gt; tags for line breaks (especially in the description text)</li>
