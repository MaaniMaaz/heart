// src/components/Admin/HomeEditor.jsx
...
const HomeEditor = () => {
  ...
  const sections = [
    ...
    { id: 'greenClean', name: 'Green Clean Section' },
    { id: 'ecoFriendly', name: 'Eco-Friendly Video Section' },
    { id: 'steps', name: '3 Easy Steps Section' },
    { id: 'testimonials', name: 'Testimonials' },
    { id: 'faq', name: 'FAQ Section' },
    { id: 'estimateBanner', name: 'Estimate Banner' }
  ];

  return (
    <div className="max-w-6xl mx-auto">
      <h2 className="text-2xl font-bold font-['Raleway'] mb-6">Edit Home Page Content</h2>
      ...
      <div className="mb-8 p-4 bg-gray-50 rounded-lg">
        ...
        <ul className="list-disc list-inside text-gray-700 text-sm space-y-1">
          ...
          <li>Add or remove items in lists by using the provided buttons</li>
        </ul>
      </div>
    </div>
  );
